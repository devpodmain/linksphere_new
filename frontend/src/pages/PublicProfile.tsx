...
const PublicProfile: React.FC = () => {
  ...
  const getShareUrl = () => {
    ...
    const baseUrl = isDevelopment 
      ? `http://localhost:5173/u/${profileUrl}` 
      : `https://qr.dzyte.com/u/${profileUrl}`;
    return baseUrl;
  };
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          {profile.collaborations && profile.collaborations.length > 0 && (
            <div className="p-6">
              <h2 className="text-lg font-semibold text-secondary-900 mb-4 text-center">Collaborations</h2>
